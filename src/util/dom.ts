...
export function createElement<K extends keyof HTMLElementTagNameMap>(tag: K | HTMLElementTagNameMap[K], data?: ElementProps<HTMLElementTagNameMap[K]> | string | null, children?: HTMLElement | Array<HTMLElement | null | undefined> | null) {
  ...
  if (typeof (data) == "string") {
    ...
    if (data.dblclick) el.addEventListener("dblclick", (e) => { if (data.dblclick) data.dblclick(el, e) });
